    ...
    <div class="tab-pane fade active show" id="kt_aside_nav_tab_projects" role="tabpanel">
        ...
        <div class="m-0">
            ...
            <div class="m-0">
                ...
                <div class="mb-10">
                    <!--begin::Item-->
                    <a href="apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
                        <!--begin::Symbol-->
                    ...
                    <a href="apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
                        ...
                        <div class="symbol symbol-40px me-5">
                            <span class="symbol-label">
                                <img src="{{ asset('assets/media/svg/brand-logos/balloon.svg') }}" class="h-50 align-self-center" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Description-->
